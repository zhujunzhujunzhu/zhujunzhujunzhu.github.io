(this["webpackJsonp"] = this["webpackJsonp"] || []).push([["chunk-3543"],{

/***/ "1m9g":
/*!***********************************************************!*\
  !*** ./src/views/project/BIM/components/myTree/index.vue ***!
  \***********************************************************/
...
/* harmony import */ var _index_vue_vue_type_template_id_42d64561___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=42d64561& */ "YaIb");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "EBKs");
/* empty/unused harmony star reexport *//* harmony import */ var _index_vue_vue_type_style_index_0_rel_stylesheet_2Fscss_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&rel=stylesheet%2Fscss&lang=scss& */ "e2sc");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_42d64561___WEBPACK_IMPORTED_MODULE_0__["render"],
  _index_vue_vue_type_template_id_42d64561___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "EBKs":
/*!************************************************************************************!*\
  !*** ./src/views/project/BIM/components/myTree/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "GuBh":
/*!***************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/happypack/loader.js?id=happyBabel!./node_modules/vue-loader/lib??vue-loader-options!./src/views/project/BIM/components/myTree/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _api_project_planRecord__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/api/project/planRecord */ "ufAr");
/* harmony import */ var _components_myContextMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/myContextMenu */ "AAk3");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'MyTree',
  components: {
    MyContextMenu: _components_myContextMenu__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
  ...
  computed: babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, Object(vuex__WEBPACK_IMPORTED_MODULE_4__["mapGetters"])(['loading', 'dictMap', 'projectButtonPrivileges', 'currentCategoryAuth', 'currentBreadcrumb'])),
  watch: {
    // 监听面包屑
    currentBreadcrumb: function currentBreadcrumb(val) {
  ...
  methods: {
    loadNode: function loadNode(node, resolve) {
      ...
      if (node.level === 0) {
        ...
        // 获取项目目录结构
        Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["categoryTreeData"])({ id: node.data ? node.data.id : null }).then(function (res) {
          if (res.success) {
    ...
    handleNodeClick: function handleNodeClick(data, node) {
      ...
      this.$store.dispatch('setLeftClickNode', data);
      this.$store.dispatch('setRightClickNode', data);
      this.leftClickNode = data;
      this.breadcrumb = [];
      this.changeBreadcrumb(node);
      this.$store.dispatch('setBreadcrumb', this.breadcrumb);
      this.$store.dispatch('setShowAuthTable', false);
      this.$store.dispatch('setIsDoc', false);
      ...
      if (data.entity) {
        Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["currCategoryActions"])({ id: data.id }).then(function (res) {
          if (res.success) {
            _this2.$store.dispatch('setCurrentCategoryAuth', res.result);
          }
        });
      }
    ...
    nodeContextmenu: function nodeContextmenu(event, data, node) {
      ...
      if (data.entity) {
        Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["currCategoryActions"])({ id: data.id }).then(function (res) {
          if (res.success) {
            _this4.$store.dispatch('setCurrentCategoryAuth', res.result);
    ...
    nodeContextmenuUtil: function nodeContextmenuUtil(event, data, node) {
      ...
      this.$store.dispatch('setContextMenuType', 'tree');
      this.$store.dispatch('setShowAuthTable', false);
      this.$store.dispatch('setRightClickNode', data);
      this.$store.dispatch('setIsDoc', false);
    ...
    addFloder: function addFloder() {
      // 判断是否有权限设置
      if (this.currentCategoryAuth.findIndex(function (item) {
    ...
    deployAuth: function deployAuth() {
      this.$store.dispatch('setInfoVisible', false);
      this.$store.dispatch('setShowAuthTable', true);
      this.$store.dispatch('setIsDoc', false);
    },
    ...
    save: function save() {
      ...
      this.$refs['categoryForm'].validate(function (valid) {
        if (valid) {
          ...
          Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["saveCategory"])(_this5.categoryForm).then(function (res) {
            if (res.success) {
    ...
    applyTree: function applyTree() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["categoryTreeData"])({
    ...
    rename: function rename() {
      ...
      this.showRightMenu = false;
      this.dialogVisible = true;
      this.categoryForm = babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, this.rightClickData.entity);
    },
    ...
    deleteFloder: function deleteFloder() {
      ...
      this.$confirm('是否确定删除该文件夹?', '提示', {
        ...
        Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["deleteCategory"])({ id: _this8.rightClickData.id }).then(function (response) {
          if (response.success) {
      ...
      switch (this.categoryForm.type) {
        ...
        case 'work_point_area':
          ...
          if (!this.rightClickData.entity || !this.rightClickData.entity.workPointId) {
            ...
            Object(_api_project_workPoint__WEBPACK_IMPORTED_MODULE_5__["getWorkPointAreaList"])({
    ...
    updateToUp: function updateToUp() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["updateToUp"])({ id: this.rightClickData.id }).then(function (res) {
        if (res.success) {
    ...
    updateToTop: function updateToTop() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["updateToTop"])({ id: this.rightClickData.id }).then(function (res) {
        if (res.success) {
    ...
    updateToUpLevel: function updateToUpLevel() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["updateToUpLevel"])({ id: this.rightClickData.id }).then(function (res) {
        if (res.success) {
    ...
    updateToDownLevel: function updateToDownLevel() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["updateToDownLevel"])({ id: this.rightClickData.id }).then(function (res) {
        if (res.success) {
    ...
    updateToDown: function updateToDown() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["updateToDown"])({ id: this.rightClickData.id }).then(function (res) {
        if (res.success) {
    ...
    updateToBottom: function updateToBottom() {
      ...
      Object(_api_project_bimFloder__WEBPACK_IMPORTED_MODULE_1__["updateToBottom"])({ id: this.rightClickData.id }).then(function (res) {
        if (res.success) {
    ...
    changeShowInPlan: function changeShowInPlan(data) {
      ...
      if (this.isDisablePrivilege) {
        ...
        Object(_api_project_planRecord__WEBPACK_IMPORTED_MODULE_2__["showCatalongPlan"])({ id: data.id }).then(function (res) {
          if (res.success) {
...
/***/ "L7+9":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/views/project/BIM/components/myTree/index.vue?vue&type=template&id=42d64561& ***!
  \************************************************************************************************************************************************************************************************************************/
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"myTree",staticClass:"my-tree"},[_c('el-tree',{ref:"tree",attrs:{"props":_vm.defaultProps,"highlight-current":true,"expand-on-click-node":false,"node-key":"id","load":_vm.loadNode,"default-expanded-keys":_vm.defaultExpandedKeys,"lazy":""},on:{"node-click":_vm.handleNodeClick,"node-contextmenu":_vm.nodeContextmenu},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var node = ref.node;
var data = ref.data;
...
/***/ "VYDI":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--11-0!./node_modules/css-loader??ref--11-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/lib??ref--11-2!./node_modules/sass-loader/lib/loader.js??ref--11-3!./node_modules/vue-loader/lib??vue-loader-options!./src/views/project/BIM/components/myTree/index.vue?vue&type=style&index=0&rel=stylesheet%2Fscss&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "YaIb":
/*!******************************************************************************************!*\
  !*** ./src/views/project/BIM/components/myTree/index.vue?vue&type=template&id=42d64561& ***!
  \******************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_42d64561___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=42d64561& */ "L7+9");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_42d64561___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_42d64561___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/***/ "e2sc":
/*!*******************************************************************************************************************!*\
  !*** ./src/views/project/BIM/components/myTree/index.vue?vue&type=style&index=0&rel=stylesheet%2Fscss&lang=scss& ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
